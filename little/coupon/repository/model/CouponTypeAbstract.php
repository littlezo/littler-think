 ...
 * @property money $float 发放面额 当type为reward时需要添加
 * @property discount $float 1 =< 折扣 <= 9.9 当type为discount时需要添加
 * @property discount_limit $float 最多折扣金额 当type为discount时可选择性添加
 * @property min_money $float 最低金额 当type为radom时需要添加
 * @property max_money $float 最大金额 当type为radom时需要添加
...
abstract class CouponTypeAbstract extends Model
{
	...
	protected $type = [
		...
		'min_money' => 'decimal',
		'max_money' => 'decimal',
		'validity_type' => 'tinyint unsigned',
		'start_use_time' => 'timestamp',
		'end_use_time' => 'timestamp',
		'fixed_term' => 'int unsigned',
		'is_limit_member' => 'tinyint unsigned',
		'member_level_ids' => 'varchar',
		'is_limitless' => 'tinyint unsigned',
		'max_fetch' => 'int unsigned',
		...
		'discount_order_money' => 'decimal',
		'order_money' => 'decimal',
		'is_forbidden' => 'tinyint unsigned',
		'old_member_num' => 'int unsigned',
		'new_member_num' => 'int unsigned',
		'order_goods_num' => 'int unsigned',
		'status' => 'int',
