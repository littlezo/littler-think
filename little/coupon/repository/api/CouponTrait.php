...
namespace little\coupon\repository\api;

use little\coupon\service\api\CouponCouponService;
use littler\Request;
...
trait CouponTrait
{
	/**
	 * @Inject()
	 * @var CouponCouponService
	 */
	protected $service;


	/**
	 * @Route("/coupon", method="GET", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "分页列表",
	 *     "version": "v1.0.0",
	 *     "name": "delete",
	...
	/**
	 * @Route("/coupon/:id", method="GET", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "详情",
	 *     "version": "v1.0.0",
	 *     "name": "delete",
	...
	/**
	 * @Route("/coupon", method="POST", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "保存",
	 *     "version": "v1.0.0",
	 *     "name": "delete",
	...
	/**
	 * @Route("/coupon/:id", method="PUT", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "更新",
	 *     "version": "v1.0.0",
	 *     "name": "delete",
	...
	/**
	 * @Route("/coupon/:id", method="DELETE", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "删除",
	 *     "version": "v1.0.0",
	 *     "name": "delete",
