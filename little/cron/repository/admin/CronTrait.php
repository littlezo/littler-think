...
namespace little\cron\repository\admin;

use little\cron\service\admin\CronService;
use littler\Request;
...
trait CronTrait
{
	...
	/**
	 * @Route("/cron/layout", method="GET", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "计划任务布局",
	 *     "version": "v1.0.0",
	 *     "name": "layout",
	...
	/**
	 * @Route("/cron/:id", method="GET", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "计划任务详情",
	 *     "version": "v1.0.0",
	 *     "name": "info",
	...
	/**
	 * @Route("/cron", method="POST", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "添加计划任务",
	 *     "version": "v1.0.0",
	 *     "name": "save",
	...
	/**
	 * @Route("/cron/:id", method="PUT", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "修改计划任务",
	 *     "version": "v1.0.0",
	 *     "name": "update",
	...
	/**
	 * @Route("/cron/:id", method="DELETE", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "删除计划任务",
	 *     "version": "v1.0.0",
	 *     "name": "delete",
