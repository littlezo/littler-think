...
namespace little\seckill\admin\controller;

use little\seckill\repository\admin\GoodsTrait;
...
/**
 * Class Goods
 * @package little\seckill\admin\controller
 * @RouteGroup("admin/seckill")
