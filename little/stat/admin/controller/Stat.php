...
namespace little\stat\admin\controller;

use little\stat\repository\admin\StatTrait;
...
/**
 * Class Stat
 * @package little\stat\admin\controller
 * @RouteGroup("admin/stat")
...
class Stat extends Controller
{
	...
	/**
	 * @Route("/stat/list", method="GET",ignore_verify=false)
	 * @apiDocs({
	 *     "title": "列表无分页",
	 *     "version": "v1.0.0",
	 *     "name": "list",
