...
namespace little\stat\repository\admin;

use little\stat\service\admin\StatService;
use littler\Request;
...
trait StatTrait
{
	...
	/**
	 * @Route("/stat_trait/layout", method="GET", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "页面布局",
	 *     "version": "v1.0.0",
	 *     "name": "layout",
	...
	/**
	 * @Route("/stat", method="GET", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "分页列表",
	 *     "version": "v1.0.0",
	 *     "name": "index",
	...
	/**
	 * @Route("/stat/:id", method="GET", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "详情",
	 *     "version": "v1.0.0",
	 *     "name": "info",
	...
	/**
	 * @Route("/stat", method="POST", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "保存",
	 *     "version": "v1.0.0",
	 *     "name": "save",
	...
	/**
	 * @Route("/stat/:id", method="PUT", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "更新",
	 *     "version": "v1.0.0",
	 *     "name": "update",
	...
	/**
	 * @Route("/stat/:id", method="DELETE", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "删除",
	 *     "version": "v1.0.0",
	 *     "name": "delete",
