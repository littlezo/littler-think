...
class Files extends Controller
{
	...
	/**
	 * @Route("^/admin/file/check", method="POST", ignore_verify=true)
	 * @apiDocs({
	 *     "title": "文件检查",
	 *     "version": "v1.0.0",
	 *     "name": "adminCheck",
	 ...
	 * @return \think\Response
	 */
	public function check(Request $request): ?\think\Response
	{
		return Response::success($this->service->check($request->param()));
	}
