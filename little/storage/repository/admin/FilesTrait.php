...
trait FilesTrait
{
	...
	/**
	 * @Route("/files/layout", method="GET", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "文件布局",
	 *     "version": "v1.0.0",
	 *     "name": "layout",
	...
	/**
	 * @Route("/files", method="GET", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "文件分页",
	 *     "version": "v1.0.0",
	 *     "name": "index",
	...
	/**
	 * @Route("/files/:id", method="GET", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "文件详情",
	 *     "version": "v1.0.0",
	 *     "name": "info",
	...
	/**
	 * @Route("/files/:id", method="PUT", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "修改文件",
	 *     "version": "v1.0.0",
	 *     "name": "update",
	...
	/**
	 * @Route("/files/:id", method="DELETE", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "删除文件",
	 *     "version": "v1.0.0",
	 *     "name": "delete",
