...
namespace little\storage\repository\admin;
...
trait GroupTrait
{
	...
	/**
	 * @Route("/group/layout", method="GET", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "文件组布局",
	 *     "version": "v1.0.0",
	 *     "name": "layout",
	...
	/**
	 * @Route("/group", method="GET", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "文件组分页",
	 *     "version": "v1.0.0",
	 *     "name": "index",
	...
	/**
	 * @Route("/group/:id", method="GET", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "文件组详情",
	 *     "version": "v1.0.0",
	 *     "name": "info",
	...
	/**
	 * @Route("/group", method="POST", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "添加文件组",
	 *     "version": "v1.0.0",
	 *     "name": "save",
	...
	/**
	 * @Route("/group/:id", method="PUT", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "修改文件组",
	 *     "version": "v1.0.0",
	 *     "name": "update",
	...
	/**
	 * @Route("/group/:id", method="DELETE", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "删除文件组",
	 *     "version": "v1.0.0",
	 *     "name": "delete",
