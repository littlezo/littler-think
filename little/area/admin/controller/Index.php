...
namespace little\area\admin\controller;

use little\area\repository\admin\AreaTrait;
use little\area\service\admin\AreaService;
 ...
 * #title 地址表
 * Class Index
 * @package little\area\admin\controller
 * @Group("admin/area")
