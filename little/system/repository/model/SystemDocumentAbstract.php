 ...
 */
abstract class SystemDocumentAbstract extends Model
{
	 ...
	 * @var string $name 表名
	 */
	protected $name = 'system_document';
	 ...
	 */
	public $field = ['id', 'site_id', 'app_module', 'document_key', 'title', 'content', 'create_time', 'modify_time'];
}
