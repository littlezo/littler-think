...
namespace little\system\api\controller;

use little\system\repository\api\ConfigTrait;
use little\system\service\api\SystemConfigService;
...
/**
 * Class Config
 * @package little\system\api\controller
 * @RouteGroup("api/system")
...
class Config extends Controller
{
	...
	/**
	 * @Route("/config/list", method="GET", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "列表无分页",
	 *     "version": "v1.0.0",
	 *     "name": "list",
