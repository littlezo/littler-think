...
use little\payment\model\PaymentRefund;
use littler\annotation\Inject;

class OnPaymentRefundSetIncByField
{
	/**
	 * @Inject()
	 * @var little\payment\model\PaymentRefund
	 */
	protected $model;
	 ...
	 * @return mixed
	 */
	public function handle(array $args, PaymentRefund $model)
	{
		// Todo: 退款记录 字段自增
