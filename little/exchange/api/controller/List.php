...
namespace little\exchange\api\controller;

use little\exchange\repository\api\ListTrait;
...
/**
 * Class List
 * @package little\exchange\api\controller
 * @RouteGroup("api/exchange")
...
class List extends Controller
{
	...
	/**
	 * @Route("/list/list", method="GET", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "列表无分页",
	 *     "version": "v1.0.0",
	 *     "name": "list",
