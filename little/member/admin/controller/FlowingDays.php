...
use little\member\service\admin\FlowingDaysService;
 ...
 * @RouteGroup("admin/member/flowing_days")
 * @Middleware({littler\JWTAuth\Middleware\Jwt::class,"admin"})
 * @apiDocs({
 *     "title": "MemberFlowingDays",
 *     "version": "1.0.0",
 *     "layer": "admin",
 *     "name": "flowing_days",
 *     "module": "member",
 ...
 * })
 */
class FlowingDays extends Controller
{
	use PageTrait;
	use InfoTrait;
	use SaveTrait;
