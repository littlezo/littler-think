...
use little\member\service\admin\RechargeService;
use littler\Request;
...
trait RechargeTrait
{
	...
	/**
	 * @Route("/recharge_trait/layout", method="GET", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "页面布局",
	 *     "version": "v1.0.0",
	 *     "name": "layout",
	...
	/**
	 * @Route("/recharge", method="GET", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "分页列表",
	 *     "version": "v1.0.0",
	 *     "name": "index",
	...
	/**
	 * @Route("/recharge/:id", method="GET", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "详情",
	 *     "version": "v1.0.0",
	 *     "name": "info",
	...
	/**
	 * @Route("/recharge", method="POST", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "保存",
	 *     "version": "v1.0.0",
	 *     "name": "save",
	...
	/**
	 * @Route("/recharge/:id", method="PUT", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "更新",
	 *     "version": "v1.0.0",
	 *     "name": "update",
	...
	/**
	 * @Route("/recharge/:id", method="DELETE", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "删除",
	 *     "version": "v1.0.0",
	 *     "name": "delete",
