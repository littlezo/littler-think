...
use little\member\repository\model\FlowingDaysAbstract;
use littler\annotation\model\relation\HasOne;

/**
 * MemberFlowingDays 模型.
 * @HasOne("member",model="User",foreignKey="id",localKey="member_id")
 */
class FlowingDays extends FlowingDaysAbstract
{
	/**
	 * @var array 关联预载
	 */
	...
	public $table_schema = [
		...
		'dropActions' => '[{"icon":"clarity:note-edit-line","label":"修改","auth":"member:flowing_days:update","onClick":"handleEdit.bind(null, record)"},{"label":"删除","icon":"ant-design:delete-outlined","color":"error","auth":"member:flowing_days:delete","popConfirm":{"title":"是否确认删除","confirm":"handleDelete.bind(null, record)"}}]',
		'actions' => '[]',
	];
