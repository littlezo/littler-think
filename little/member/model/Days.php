...
class Days extends DaysAbstract
{
	...
	public $table_schema = [
		...
		'dropActions' => '[{"icon":"clarity:note-edit-line","label":"修改","auth":"member:days:update","onClick":"handleEdit.bind(null, record)"},{"label":"删除","icon":"ant-design:delete-outlined","color":"error","auth":"member:days:delete","popConfirm":{"title":"是否确认删除","confirm":"handleDelete.bind(null, record)"}}]',
		'actions' => '[]',
	];
