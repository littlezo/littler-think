...
namespace little\document\admin\controller;

use little\document\repository\admin\DocumentTrait;
use little\document\service\admin\DocumentService;
 ...
 * #title 系统配置性相关文件
 * Class Index
 * @package little\document\admin\controller
