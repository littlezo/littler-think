...
use little\goods\model\GoodsAttribute;
use littler\annotation\Inject;

class OnGoodsAttributeSetIncByField
{
	/**
	 * @Inject()
	 * @var little\goods\model\GoodsAttribute
	 */
	protected $model;
	 ...
	 * @return mixed
	 */
	public function handle(array $args, GoodsAttribute $model)
	{
		// Todo: 商品属性 字段自增
