...
use little\goods\model\GoodsCategory;
use littler\annotation\Inject;

class OnGoodsCategorySetDecByField
{
	/**
	 * @Inject()
	 * @var little\goods\model\GoodsCategory
	 */
	protected $model;
	 ...
	 * @return mixed
	 */
	public function handle(array $args, GoodsCategory $model)
	{
		// Todo:  商品分类 字段自减
