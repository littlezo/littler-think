 ...
 */
abstract class GoodsAttrIndexAbstract extends Model
{
	 ...
	 * @var string $name 表名
	 */
	protected $name = 'goods_attr_index';
	 ...
	 */
	protected $field = ['id', 'goods_id', 'sku_id', 'attr_id', 'attr_value_id', 'attr_class_id', 'app_module'];
}
