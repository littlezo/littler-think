 ...
 */
abstract class GoodsEvaluateAbstract extends Model
{
	 ...
	 */
	protected $type = [
		'evaluate_id' => 'int unsigned',
		'site_id' => 'int',
		'website_id' => 'int',
		'order_id' => 'int',
		'order_no' => 'bigint unsigned',
		'order_goods_id' => 'int',
		'goods_id' => 'int',
		'sku_id' => 'int',
		'sku_name' => 'varchar',
		...
		'content' => 'varchar',
		'images' => 'varchar',
		'explain_first' => 'varchar',
		'member_id' => 'int',
		'member_name' => 'varchar',
		'member_headimg' => 'varchar',
		'is_anonymous' => 'tinyint',
		'scores' => 'tinyint',
		'again_content' => 'varchar',
		'again_images' => 'varchar',
		'again_explain' => 'varchar',
		'explain_type' => 'int',
		'is_show' => 'int',
		'create_time' => 'timestamp',
		'again_time' => 'timestamp',
		'shop_desccredit' => 'decimal',
		'shop_servicecredit' => 'decimal',
		'shop_deliverycredit' => 'decimal',
	];
