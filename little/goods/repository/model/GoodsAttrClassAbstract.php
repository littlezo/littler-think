 ...
 */
abstract class GoodsAttrClassAbstract extends Model
{
	 ...
	 */
	protected $type = ['class_id' => 'int', 'class_name' => 'varchar', 'site_id' => 'int', 'sort' => 'int'];
	 ...
	 */
	protected $field = ['class_id', 'class_name', 'site_id', 'sort'];
}
