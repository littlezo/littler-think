...
trait SkuTrait
{
	...
	/**
	 * @Route("/sku/layout", method="GET", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "商品SKU布局",
	 *     "version": "v1.0.0",
	 *     "name": "layout",
	...
	/**
	 * @Route("/sku", method="GET", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "商品SKU分页",
	 *     "version": "v1.0.0",
	 *     "name": "index",
	...
	/**
	 * @Route("/sku/:id", method="GET", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "商品SKU详情",
	 *     "version": "v1.0.0",
	 *     "name": "info",
	...
	/**
	 * @Route("/sku", method="POST", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "添加商品SKU",
	 *     "version": "v1.0.0",
	 *     "name": "save",
	...
	/**
	 * @Route("/sku/:id", method="PUT", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "修改商品SKU",
	 *     "version": "v1.0.0",
	 *     "name": "update",
	...
	/**
	 * @Route("/sku/:id", method="DELETE", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "删除商品SKU",
	 *     "version": "v1.0.0",
	 *     "name": "delete",
