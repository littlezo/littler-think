...
use little\goods\service\admin\DetailService;
use littler\Request;
...
trait DetailTrait
{
	...
	/**
	 * @Route("/detail/layout", method="GET", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "商品列表布局",
	 *     "version": "v1.0.0",
	 *     "name": "layout",
	...
	/**
	 * @Route("/detail", method="GET", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "商品列表分页",
	 *     "version": "v1.0.0",
	 *     "name": "index",
	...
	/**
	 * @Route("/detail/:id", method="GET", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "商品列表详情",
	 *     "version": "v1.0.0",
	 *     "name": "info",
	...
	/**
	 * @Route("/detail", method="POST", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "添加商品列表",
	 *     "version": "v1.0.0",
	 *     "name": "save",
	...
	/**
	 * @Route("/detail/:id", method="PUT", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "修改商品列表",
	 *     "version": "v1.0.0",
	 *     "name": "update",
	...
	/**
	 * @Route("/detail/:id", method="DELETE", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "删除商品列表",
	 *     "version": "v1.0.0",
	 *     "name": "delete",
