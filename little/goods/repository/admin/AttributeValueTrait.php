...
use little\goods\service\admin\AttributeValueService;
use littler\Request;
...
trait AttributeValueTrait
{
	...
	/**
	 * @Route("/attribute_value/layout", method="GET", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "商品属性值布局",
	 *     "version": "v1.0.0",
	 *     "name": "layout",
	...
	/**
	 * @Route("/attribute_value", method="GET", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "商品属性值分页",
	 *     "version": "v1.0.0",
	 *     "name": "index",
	...
	/**
	 * @Route("/attribute_value/:id", method="GET", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "商品属性值详情",
	 *     "version": "v1.0.0",
	 *     "name": "info",
	...
	/**
	 * @Route("/attribute_value", method="POST", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "添加商品属性值",
	 *     "version": "v1.0.0",
	 *     "name": "save",
	...
	/**
	 * @Route("/attribute_value/:id", method="PUT", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "修改商品属性值",
	 *     "version": "v1.0.0",
	 *     "name": "update",
	...
	/**
	 * @Route("/attribute_value/:id", method="DELETE", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "删除商品属性值",
	 *     "version": "v1.0.0",
	 *     "name": "delete",
