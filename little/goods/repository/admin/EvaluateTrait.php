...
use little\goods\service\admin\EvaluateService;
use littler\Request;
...
trait EvaluateTrait
{
	...
	/**
	 * @Route("/evaluate/layout", method="GET", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "商品评价布局",
	 *     "version": "v1.0.0",
	 *     "name": "layout",
	...
	/**
	 * @Route("/evaluate", method="GET", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "商品评价分页",
	 *     "version": "v1.0.0",
	 *     "name": "index",
	...
	/**
	 * @Route("/evaluate/:id", method="GET", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "商品评价详情",
	 *     "version": "v1.0.0",
	 *     "name": "info",
	...
	/**
	 * @Route("/evaluate", method="POST", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "添加商品评价",
	 *     "version": "v1.0.0",
	 *     "name": "save",
	...
	/**
	 * @Route("/evaluate/:id", method="PUT", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "修改商品评价",
	 *     "version": "v1.0.0",
	 *     "name": "update",
	...
	/**
	 * @Route("/evaluate/:id", method="DELETE", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "删除商品评价",
	 *     "version": "v1.0.0",
	 *     "name": "delete",
