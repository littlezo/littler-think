...
use little\goods\service\admin\GoodsAttrClassService;
use littler\Request;
...
trait AttrClassTrait
{
	/**
	 * @Inject()
	 * @var GoodsAttrClassService
	 */
	protected $service;


	/**
	 * @Route("/attr_class", method="GET",ignore_verify=true)
	 * @apiDocs({
	 *     "title": "分页列表",
	 *     "version": "v1.0.0",
	 *     "name": "delete",
	...
	/**
	 * @Route("/attr_class/:id", method="GET",ignore_verify=true)
	 * @apiDocs({
	 *     "title": "详情",
	 *     "version": "v1.0.0",
	 *     "name": "delete",
	...
	/**
	 * @Route("/attr_class", method="POST",ignore_verify=true)
	 * @apiDocs({
	 *     "title": "保存",
	 *     "version": "v1.0.0",
	 *     "name": "delete",
	...
	/**
	 * @Route("/attr_class/:id", method="PUT",ignore_verify=true)
	 * @apiDocs({
	 *     "title": "更新",
	 *     "version": "v1.0.0",
	 *     "name": "delete",
	...
	/**
	 * @Route("/attr_class/:id", method="DELETE",ignore_verify=true)
	 * @apiDocs({
	 *     "title": "删除",
	 *     "version": "v1.0.0",
	 *     "name": "delete",
