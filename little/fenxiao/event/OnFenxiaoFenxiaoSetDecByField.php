...
use little\fenxiao\model\FenxiaoFenxiao;
use littler\annotation\Inject;

class OnFenxiaoFenxiaoSetDecByField
{
	/**
	 * @Inject()
	 * @var little\fenxiao\model\FenxiaoFenxiao
	 */
	protected $model;
	 ...
	 * @return mixed
	 */
	public function handle(array $args, FenxiaoFenxiao $model)
	{
		// Todo: 分销商 字段自减
