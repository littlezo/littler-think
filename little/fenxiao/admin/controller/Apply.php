...
namespace little\fenxiao\admin\controller;

use little\fenxiao\repository\admin\ApplyTrait;
...
/**
 * Class Apply
 * @package little\fenxiao\admin\controller
 * @RouteGroup("admin/fenxiao")
...
class Apply extends Controller
{
	...
	/**
	 * @Route("/apply/list", method="GET", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "分销申请列表",
	 *     "version": "v1.0.0",
	 *     "name": "list",
