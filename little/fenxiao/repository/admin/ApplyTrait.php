...
use little\fenxiao\service\admin\ApplyService;
use littler\Request;
...
trait ApplyTrait
{
	...
	/**
	 * @Route("/apply/layout", method="GET", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "分销申请布局",
	 *     "version": "v1.0.0",
	 *     "name": "layout",
	...
	/**
	 * @Route("/apply", method="GET", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "分销申请分页",
	 *     "version": "v1.0.0",
	 *     "name": "index",
	...
	/**
	 * @Route("/apply/:id", method="GET", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "分销申请详情",
	 *     "version": "v1.0.0",
	 *     "name": "info",
	...
	/**
	 * @Route("/apply", method="POST", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "添加分销申请",
	 *     "version": "v1.0.0",
	 *     "name": "save",
	...
	/**
	 * @Route("/apply/:id", method="PUT", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "修改分销申请",
	 *     "version": "v1.0.0",
	 *     "name": "update",
	...
	/**
	 * @Route("/apply/:id", method="DELETE", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "删除分销申请",
	 *     "version": "v1.0.0",
	 *     "name": "delete",
