 ...
 */
abstract class FenxiaoWithdrawAbstract extends Model
{
	...
	protected $type = [
		...
		'transfer_type' => 'int',
		'transfer_name' => 'varchar',
		'transfer_remark' => 'varchar',
		'transfer_no' => 'varchar',
		'transfer_account_no' => 'varchar',
	];
