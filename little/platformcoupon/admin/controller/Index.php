...
namespace little\platformcoupon\admin\controller;

use little\platformcoupon\repository\admin\PlatformcouponTrait;
use little\platformcoupon\service\admin\PlatformcouponService;
 ...
 * #title 优惠券表
 * Class Index
 * @package little\platformcoupon\admin\controller
 * @Group("admin/platformcoupon")
 * @Middleware({littler\JWTAuth\Middleware\Jwt::class,"admin"})
 */
class Index extends Controller
{
	use PlatformcouponTrait;

	/**
	 * @Inject()
	 * @var PlatformcouponService
	 */
	protected $service;
