...
namespace little\message\api\controller;

use little\message\repository\api\EmailRecordsTrait;
...
/**
 * Class EmailRecords
 * @package little\message\api\controller
 ...
 * })
 */
class EmailRecords extends Controller
{
	use EmailRecordsTrait;
