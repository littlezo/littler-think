...
use little\message\service\admin\NoticeService;
use littler\Request;
...
trait NoticeTrait
{
	...
	/**
	 * @Route("/notice/layout", method="GET", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "消息公告通知布局",
	 *     "version": "v1.0.0",
	 *     "name": "layout",
	...
	/**
	 * @Route("/notice", method="GET", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "消息公告通知分页",
	 *     "version": "v1.0.0",
	 *     "name": "index",
	...
	/**
	 * @Route("/notice/:id", method="GET", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "消息公告通知详情",
	 *     "version": "v1.0.0",
	 *     "name": "info",
	...
	/**
	 * @Route("/notice", method="POST", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "添加消息公告通知",
	 *     "version": "v1.0.0",
	 *     "name": "save",
	...
	/**
	 * @Route("/notice/:id", method="PUT", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "修改消息公告通知",
	 *     "version": "v1.0.0",
	 *     "name": "update",
	...
	/**
	 * @Route("/notice/:id", method="DELETE", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "删除消息公告通知",
	 *     "version": "v1.0.0",
	 *     "name": "delete",
