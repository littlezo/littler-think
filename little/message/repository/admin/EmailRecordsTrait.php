...
namespace little\message\repository\admin;

use little\message\service\admin\EmailRecordsService;
use littler\Request;
 ...
 */
trait EmailRecordsTrait
{
	/**
	 * @Inject()
	 * @var EmailRecordsService
	 */
	protected $service;


	/**
	 * @Route("/email_records_trait/layout", method="GET", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "页面布局",
	 *     "version": "v1.0.0",
	 *     "name": "layout",
	...
	/**
	 * @Route("/email_records", method="GET", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "分页列表",
	 *     "version": "v1.0.0",
	 *     "name": "index",
	...
	/**
	 * @Route("/email_records/:id", method="GET", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "详情",
	 *     "version": "v1.0.0",
	 *     "name": "info",
	...
	/**
	 * @Route("/email_records", method="POST", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "保存",
	 *     "version": "v1.0.0",
	 *     "name": "save",
	...
	/**
	 * @Route("/email_records/:id", method="PUT", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "更新",
	 *     "version": "v1.0.0",
	 *     "name": "update",
	...
	/**
	 * @Route("/email_records/:id", method="DELETE", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "删除",
	 *     "version": "v1.0.0",
	 *     "name": "delete",
