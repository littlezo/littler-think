...
namespace little\help\repository\admin;

use little\help\service\admin\HelpClassService;
use littler\Request;
...
trait ClassTrait
{
	/**
	 * @Inject()
	 * @var HelpClassService
	 */
	protected $service;


	/**
	 * @Route("/class", method="GET",ignore_verify=true)
	 * @apiDocs({
	 *     "title": "分页列表",
	 *     "version": "v1.0.0",
	 *     "name": "delete",
	...
	/**
	 * @Route("/class/:id", method="GET",ignore_verify=true)
	 * @apiDocs({
	 *     "title": "详情",
	 *     "version": "v1.0.0",
	 *     "name": "delete",
	...
	/**
	 * @Route("/class", method="POST",ignore_verify=true)
	 * @apiDocs({
	 *     "title": "保存",
	 *     "version": "v1.0.0",
	 *     "name": "delete",
	...
	/**
	 * @Route("/class/:id", method="PUT",ignore_verify=true)
	 * @apiDocs({
	 *     "title": "更新",
	 *     "version": "v1.0.0",
	 *     "name": "delete",
	...
	/**
	 * @Route("/class/:id", method="DELETE",ignore_verify=true)
	 * @apiDocs({
	 *     "title": "删除",
	 *     "version": "v1.0.0",
	 *     "name": "delete",
