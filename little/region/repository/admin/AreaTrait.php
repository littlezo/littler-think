...
namespace little\region\repository\admin;

use little\region\service\admin\RegionAreaService;
use littler\Request;
...
trait AreaTrait
{
	/**
	 * @Inject()
	 * @var RegionAreaService
	 */
	protected $service;


	/**
	 * @Route("/area", method="GET",ignore_verify=true)
	 * @apiDocs({
	 *     "title": "分页列表",
	 *     "version": "v1.0.0",
	 *     "name": "delete",
	...
	/**
	 * @Route("/area/:id", method="GET",ignore_verify=true)
	 * @apiDocs({
	 *     "title": "详情",
	 *     "version": "v1.0.0",
	 *     "name": "delete",
	...
	/**
	 * @Route("/area", method="POST",ignore_verify=true)
	 * @apiDocs({
	 *     "title": "保存",
	 *     "version": "v1.0.0",
	 *     "name": "delete",
	...
	/**
	 * @Route("/area/:id", method="PUT",ignore_verify=true)
	 * @apiDocs({
	 *     "title": "更新",
	 *     "version": "v1.0.0",
	 *     "name": "delete",
	...
	/**
	 * @Route("/area/:id", method="DELETE",ignore_verify=true)
	 * @apiDocs({
	 *     "title": "删除",
	 *     "version": "v1.0.0",
	 *     "name": "delete",
