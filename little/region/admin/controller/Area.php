...
namespace little\region\admin\controller;

use little\region\repository\admin\AreaTrait;
...
/**
 * Class Area
 * @package little\region\admin\controller
 * @RouteGroup("admin/region")
...
class Area extends Controller
{
	...
	/**
	 * @Route("/area/list", method="GET",ignore_verify=false)
	 * @apiDocs({
	 *     "title": "列表无分页",
	 *     "version": "v1.0.0",
	 *     "name": "list",
