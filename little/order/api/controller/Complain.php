...
namespace little\order\api\controller;

use little\order\repository\api\ComplainTrait;
use little\order\service\api\OrderComplainService;
...
/**
 * Class Complain
 * @package little\order\api\controller
 * @RouteGroup("api/order")
