...
abstract class OrderAbstract extends Model
{
	...
	protected $type = [
		...
		'order_promotion_type' => 'int',
		'order_promotion_name' => 'varchar',
		'promotion_id' => 'int',
		'out_trade_no' => 'varchar',
		'out_trade_no_2' => 'varchar',
		'delivery_code' => 'varchar',
		'order_status' => 'int',
		'order_status_name' => 'varchar',
		'order_status_action' => 'varchar',
		'pay_status' => 'int',
		'delivery_status' => 'int',
		'refund_status' => 'int',
		'pay_type' => 'varchar',
		...
		'latitude' => 'varchar',
		'buyer_ip' => 'varchar',
		'buyer_ask_delivery_time' => 'timestamp',
		'buyer_message' => 'varchar',
		'order_invoice_company' => 'varchar',
		'order_invoice_type' => 'int',
		'order_invoice_type_name' => 'varchar',
		'order_invoice_trade_type' => 'int',
		'order_invoice_rate' => 'decimal',
		'goods_money' => 'decimal',
		'delivery_money' => 'decimal',
		'promotion_money' => 'decimal',
		'coupon_id' => 'int',
		'coupon_money' => 'decimal',
		'invoice_money' => 'decimal',
		'order_money' => 'decimal',
		'adjust_money' => 'decimal',
		...
		'goods_num' => 'int',
		'delivery_store_id' => 'int',
		'delivery_status_name' => 'varchar',
		'is_settlement' => 'tinyint',
		'delivery_store_name' => 'varchar',
		'promotion_type' => 'varchar',
		'promotion_type_name' => 'varchar',
		'promotion_status_name' => 'varchar',
		'delivery_store_info' => 'varchar',
		'virtual_code' => 'varchar',
		'evaluate_status' => 'int',
		'evaluate_status_name' => 'varchar',
		'shop_money' => 'decimal',
		...
		'platform_coupon_total_money' => 'decimal',
		'platform_coupon_shop_money' => 'decimal',
		'is_invoice' => 'int',
		'invoice_type' => 'int',
		...
		'invoice_delivery_money' => 'decimal',
		'invoice_full_address' => 'varchar',
		'is_tax_invoice' => 'int',
