...
abstract class OrderComplainAbstract extends Model
{
	...
	protected $type = [
		...
		'complain_no' => 'varchar',
		'complain_status' => 'int',
		'complain_status_name' => 'varchar',
		'complain_apply_money' => 'decimal',
		'complain_reason' => 'varchar',
		'complain_real_money' => 'decimal',
		'complain_time' => 'timestamp',
		'complain_refuse_reason' => 'varchar',
		'complain_remark' => 'varchar',
		'complain_money_type' => 'int',
		'complain_apply_time' => 'timestamp',
		'complain_status_action' => 'varchar',
