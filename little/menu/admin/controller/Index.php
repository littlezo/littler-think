...
namespace little\menu\admin\controller;

use little\menu\repository\admin\MenuTrait;
use little\menu\service\admin\MenuService;
 ...
 * #title 菜单表
 * Class Index
 * @package little\menu\admin\controller
 * @Group("admin/menu")
