...
namespace little\pintuan\admin\controller;

use little\pintuan\repository\admin\GoodsTrait;
...
/**
 * Class Goods
 * @package little\pintuan\admin\controller
 * @RouteGroup("admin/pintuan")
