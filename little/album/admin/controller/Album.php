...
namespace little\album\admin\controller;

use little\album\repository\admin\AlbumTrait;
use little\album\service\admin\AlbumAlbumService;
...
/**
 * Class Album
 * @package little\album\admin\controller
 * @RouteGroup("admin/album")
...
class Album extends Controller
{
	...
	/**
	 * @Inject()
	 * @var AlbumAlbumService
	 */
	protected $service;


	/**
	 * @Route("/album/list", method="GET", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "列表无分页",
	 *     "version": "v1.0.0",
	 *     "name": "list",
