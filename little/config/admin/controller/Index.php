...
namespace little\config\admin\controller;

use little\config\repository\admin\ConfigTrait;
use little\config\service\admin\ConfigService;
 ...
 * #title 系统配置表
 * Class Index
 * @package little\config\admin\controller
 * @Group("admin/config")
