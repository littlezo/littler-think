...
namespace little\verifier\admin\controller;

use little\verifier\repository\admin\CodeTrait;
...
/**
 * Class Code
 * @package little\verifier\admin\controller
...
class Code extends Controller
{
	...
	/**
	 * @Route("/code/list", method="GET",ignore_verify=true)
	 * @apiDocs({
	 *     "title": "列表无分页",
	 *     "version": "v1.0.0",
	 *     "name": "list",
