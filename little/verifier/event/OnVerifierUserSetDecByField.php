...
use little\verifier\model\VerifierUser;
use littler\annotation\Inject;

class OnVerifierUserSetDecByField
{
	/**
	 * @Inject()
	 * @var little\verifier\model\VerifierUser
	 */
	protected $model;
	 ...
	 * @return mixed
	 */
	public function handle(array $args, VerifierUser $model)
	{
		// Todo: 线下核销 字段自减
