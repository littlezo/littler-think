...
namespace little\verifier\api\controller;

use little\verifier\repository\api\CodeTrait;
use little\verifier\service\api\VerifierCodeService;
...
/**
 * Class Code
 * @package little\verifier\api\controller
 * @RouteGroup("api/verifier")
