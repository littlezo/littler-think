 ...
 */
abstract class VerifierAbstract extends Model
{
	 ...
	 */
	protected $field = ['verifier_id', 'verifier_name', 'site_id', 'member_id', 'uid', 'create_time', 'modify_time'];
}
