...
use little\shop\repository\admin\WithdrawPeriodTrait;
...
/**
 * Class WithdrawPeriod
 * @package little\shop\admin\controller
 * @RouteGroup("admin/shop")
 ...
 *     "module": "shop",
 *     "group": "withdraw_period",
 *     "desc": "查询参数详见快速查询 字段含义参加字段映射"
 * })
 */
class WithdrawPeriod extends Controller
{
	use WithdrawPeriodTrait;
	...
	/**
	 * @Route("/withdraw_period/list", method="GET", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "商家结算账期列表",
	 *     "version": "v1.0.0",
	 *     "name": "list",
