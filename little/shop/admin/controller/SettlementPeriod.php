...
use little\shop\repository\admin\SettlementPeriodTrait;
 ...
 * })
 */
class SettlementPeriod extends Controller
{
	use SettlementPeriodTrait;
	...
	/**
	 * @Route("/settlement_period/list", method="GET", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "商家结算流水列表",
	 *     "version": "v1.0.0",
	 *     "name": "list",
