...
use little\shop\service\admin\SettlementService;
use littler\Request;
...
trait SettlementTrait
{
	...
	/**
	 * @Route("/settlement/layout", method="GET", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "商家结算布局",
	 *     "version": "v1.0.0",
	 *     "name": "layout",
	...
	/**
	 * @Route("/settlement", method="GET", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "商家结算分页",
	 *     "version": "v1.0.0",
	 *     "name": "index",
	...
	/**
	 * @Route("/settlement/:id", method="GET", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "商家结算详情",
	 *     "version": "v1.0.0",
	 *     "name": "info",
	...
	/**
	 * @Route("/settlement", method="POST", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "添加商家结算",
	 *     "version": "v1.0.0",
	 *     "name": "save",
	...
	/**
	 * @Route("/settlement/:id", method="PUT", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "修改商家结算",
	 *     "version": "v1.0.0",
	 *     "name": "update",
	...
	/**
	 * @Route("/settlement/:id", method="DELETE", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "删除商家结算",
	 *     "version": "v1.0.0",
	 *     "name": "delete",
