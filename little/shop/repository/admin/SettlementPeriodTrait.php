...
namespace little\shop\repository\admin;

use little\shop\service\admin\SettlementPeriodService;
use littler\Request;
 ...
 */
trait SettlementPeriodTrait
{
	/**
	 * @Inject()
	 * @var SettlementPeriodService
	 */
	protected $service;


	/**
	 * @Route("/settlement_period/layout", method="GET", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "商家结算流水布局",
	 *     "version": "v1.0.0",
	 *     "name": "layout",
	...
	/**
	 * @Route("/settlement_period", method="GET", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "商家结算流水分页",
	 *     "version": "v1.0.0",
	 *     "name": "index",
	...
	/**
	 * @Route("/settlement_period/:id", method="GET", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "商家结算流水详情",
	 *     "version": "v1.0.0",
	 *     "name": "info",
	...
	/**
	 * @Route("/settlement_period", method="POST", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "添加商家结算流水",
	 *     "version": "v1.0.0",
	 *     "name": "save",
	...
	/**
	 * @Route("/settlement_period/:id", method="PUT", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "修改商家结算流水",
	 *     "version": "v1.0.0",
	 *     "name": "update",
	...
	/**
	 * @Route("/settlement_period/:id", method="DELETE", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "删除商家结算流水",
	 *     "version": "v1.0.0",
	 *     "name": "delete",
