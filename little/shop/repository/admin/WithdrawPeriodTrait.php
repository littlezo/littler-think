...
use little\shop\service\admin\WithdrawPeriodService;
use littler\Request;
 ...
 */
trait WithdrawPeriodTrait
{
	/**
	 * @Inject()
	 * @var WithdrawPeriodService
	 */
	protected $service;


	/**
	 * @Route("/withdraw_period/layout", method="GET", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "商家结算账期布局",
	 *     "version": "v1.0.0",
	 *     "name": "layout",
	...
	/**
	 * @Route("/withdraw_period", method="GET", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "商家结算账期分页",
	 *     "version": "v1.0.0",
	 *     "name": "index",
	...
	/**
	 * @Route("/withdraw_period/:id", method="GET", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "商家结算账期详情",
	 *     "version": "v1.0.0",
	 *     "name": "info",
	...
	/**
	 * @Route("/withdraw_period", method="POST", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "添加商家结算账期",
	 *     "version": "v1.0.0",
	 *     "name": "save",
	...
	/**
	 * @Route("/withdraw_period/:id", method="PUT", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "修改商家结算账期",
	 *     "version": "v1.0.0",
	 *     "name": "update",
	...
	/**
	 * @Route("/withdraw_period/:id", method="DELETE", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "删除商家结算账期",
	 *     "version": "v1.0.0",
	 *     "name": "delete",
