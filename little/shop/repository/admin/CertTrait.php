...
use little\shop\service\admin\CertService;
use littler\Request;
...
trait CertTrait
{
	...
	/**
	 * @Route("/cert/layout", method="GET", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "商家认证布局",
	 *     "version": "v1.0.0",
	 *     "name": "layout",
	...
	/**
	 * @Route("/cert", method="GET", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "商家认证分页",
	 *     "version": "v1.0.0",
	 *     "name": "index",
	...
	/**
	 * @Route("/cert/:id", method="GET", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "商家认证详情",
	 *     "version": "v1.0.0",
	 *     "name": "info",
	...
	/**
	 * @Route("/cert", method="POST", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "添加商家认证",
	 *     "version": "v1.0.0",
	 *     "name": "save",
	...
	/**
	 * @Route("/cert/:id", method="PUT", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "修改商家认证",
	 *     "version": "v1.0.0",
	 *     "name": "update",
	...
	/**
	 * @Route("/cert/:id", method="DELETE", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "删除商家认证",
	 *     "version": "v1.0.0",
	 *     "name": "delete",
