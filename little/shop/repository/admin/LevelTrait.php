...
use little\shop\service\admin\LevelService;
use littler\Request;
...
trait LevelTrait
{
	...
	/**
	 * @Route("/level/layout", method="GET", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "商家等级布局",
	 *     "version": "v1.0.0",
	 *     "name": "layout",
	...
	/**
	 * @Route("/level", method="GET", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "商家等级分页",
	 *     "version": "v1.0.0",
	 *     "name": "index",
	...
	/**
	 * @Route("/level/:id", method="GET", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "商家等级详情",
	 *     "version": "v1.0.0",
	 *     "name": "info",
	...
	/**
	 * @Route("/level", method="POST", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "添加商家等级",
	 *     "version": "v1.0.0",
	 *     "name": "save",
	...
	/**
	 * @Route("/level/:id", method="PUT", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "修改商家等级",
	 *     "version": "v1.0.0",
	 *     "name": "update",
	...
	/**
	 * @Route("/level/:id", method="DELETE", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "删除商家等级",
	 *     "version": "v1.0.0",
	 *     "name": "delete",
