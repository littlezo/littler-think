 ...
 */
abstract class ShopReopenAbstract extends Model
{
	...
	protected $type = [
		...
		'member_id' => 'int',
		'apply_state' => 'int',
		'apply_message' => 'varchar',
		'apply_year' => 'int',
		'shop_group_name' => 'varchar',
		'shop_group_id' => 'int',
		'paying_money_certificate' => 'varchar',
		'paying_amount' => 'decimal',
		'paying_money_certificate_explain' => 'varchar',
