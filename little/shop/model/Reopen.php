...
use little\shop\repository\model\ReopenAbstract;

/**
 * 商家续签表 模型
 */
class Reopen extends ReopenAbstract
{
	/**
	 * @var array 关联预载
	 */
	...
	public $table_schema = [
		'columns' => [
			...
			[
				'title' => '申请状态 1. 待审核 -1.审核失败 2.审核成功',
			...
			[
				'title' => '付款凭证',
				'dataIndex' => 'paying_money_certificate',
				'width' => 180,
				'fixed' => false,
				'align' => 'center',
				'defaultHidden' => false,
			...
			[
				'title' => '付款凭证说明',
				'dataIndex' => 'paying_money_certificate_explain',
				'width' => 180,
				'fixed' => false,
				'align' => 'center',
				'defaultHidden' => false,
	...
	public $form_schema = [
		...
		'schemas' => [
			...
			[
				'field' => 'apply_state',
				'label' => '申请状态 1. 待审核 -1.审核失败 2.审核成功',
				'component' => 'Input',
				'required' => true,
				'colProps' => ['lg' => 12, 'xl' => 8, 'xxl' => 6],
			],
