...
abstract class ExpressAbstract extends Model
{
	...
	protected $type = [
		...
		'url' => 'varchar',
		'sort' => 'int',
		'express_no_kdniao' => 'varchar',
		'express_no_kd100_free' => 'varchar',
		'express_no_kd100' => 'varchar',
		'express_no_cainiao' => 'varchar',
		'express_no_ext' => 'varchar',
