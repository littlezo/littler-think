 ...
 */
abstract class ExpressDeliveryPackageAbstract extends Model
{
	 ...
	 * @var string $name 表名
	 */
	protected $name = 'express_delivery_package';
	...
	protected $type = [
		...
		'site_id' => 'int',
		'order_id' => 'int',
		'order_goods_id_array' => 'varchar',
		'goods_id_array' => 'varchar',
		'package_name' => 'varchar',
		'delivery_type' => 'tinyint',
		'express_company_id' => 'int',
		'express_company_name' => 'varchar',
		'delivery_no' => 'varchar',
		'delivery_time' => 'timestamp',
		'member_id' => 'int',
		'member_name' => 'varchar',
		'express_company_image' => 'varchar',
		'type' => 'varchar',
		'template_id' => 'int',
