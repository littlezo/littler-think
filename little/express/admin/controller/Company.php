...
namespace little\express\admin\controller;

use little\express\repository\admin\CompanyTrait;
...
/**
 * Class Company
 * @package little\express\admin\controller
 * @RouteGroup("admin/express")
...
class Company extends Controller
{
	...
	/**
	 * @Route("/company/list", method="GET", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "列表无分页",
	 *     "version": "v1.0.0",
	 *     "name": "list",
