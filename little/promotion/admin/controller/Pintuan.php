...
namespace little\promotion\admin\controller;

use little\promotion\repository\admin\PintuanTrait;
...
/**
 * Class Pintuan
 * @package little\promotion\admin\controller
 * @RouteGroup("admin/promotion")
...
class Pintuan extends Controller
{
	...
	/**
	 * @Route("/pintuan/list", method="GET", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "营销拼团列表",
	 *     "version": "v1.0.0",
	 *     "name": "list",
