...
namespace little\promotion\repository\admin;

use little\promotion\service\admin\PintuanService;
use littler\Request;
...
trait PintuanTrait
{
	...
	/**
	 * @Route("/pintuan/layout", method="GET", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "营销拼团布局",
	 *     "version": "v1.0.0",
	 *     "name": "layout",
	...
	/**
	 * @Route("/pintuan", method="GET", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "营销拼团分页",
	 *     "version": "v1.0.0",
	 *     "name": "index",
	...
	/**
	 * @Route("/pintuan/:id", method="GET", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "营销拼团详情",
	 *     "version": "v1.0.0",
	 *     "name": "info",
	...
	/**
	 * @Route("/pintuan", method="POST", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "添加营销拼团",
	 *     "version": "v1.0.0",
	 *     "name": "save",
	...
	/**
	 * @Route("/pintuan/:id", method="PUT", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "修改营销拼团",
	 *     "version": "v1.0.0",
	 *     "name": "update",
	...
	/**
	 * @Route("/pintuan/:id", method="DELETE", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "删除营销拼团",
	 *     "version": "v1.0.0",
	 *     "name": "delete",
