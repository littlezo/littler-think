...
namespace little\printer\repository\admin;

use little\printer\service\admin\PrinterService;
use littler\Request;
...
trait PrinterTrait
{
	...
	/**
	 * @Route("/printer_trait/layout", method="GET", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "页面布局",
	 *     "version": "v1.0.0",
	 *     "name": "layout",
	...
	/**
	 * @Route("/printer", method="GET", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "分页列表",
	 *     "version": "v1.0.0",
	 *     "name": "index",
	...
	/**
	 * @Route("/printer/:id", method="GET", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "详情",
	 *     "version": "v1.0.0",
	 *     "name": "info",
	...
	/**
	 * @Route("/printer", method="POST", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "保存",
	 *     "version": "v1.0.0",
	 *     "name": "save",
	...
	/**
	 * @Route("/printer/:id", method="PUT", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "更新",
	 *     "version": "v1.0.0",
	 *     "name": "update",
	...
	/**
	 * @Route("/printer/:id", method="DELETE", ignore_verify=false)
	 * @apiDocs({
	 *     "title": "删除",
	 *     "version": "v1.0.0",
	 *     "name": "delete",
